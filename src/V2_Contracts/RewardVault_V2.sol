...
import { IRewardVault_V1 } from "../V1_Contracts/interfaces/IRewardVault_V1.sol";
    ...
    IRewardVault_V1
{
        ...
        onlyWhitelistedToken(token)
    {
        ...
        // Allows updating the incentive rate if the remaining incentive amount is 0 and
